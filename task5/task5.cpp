...
public:
  ...
  States_dot calculateStatesDot(float thr, float ste, float bra, Kesi kesi)
  {
    ...
    states_dot_dyn.vx_dot = 1 / m *
                            (m * kesi.v_y * kesi.r + Fxf * cos(kesi_new.steering_angle) + Fxr -
    ...
    states_dot_dyn.r_dot =
      1 / Iz *
      ((Fyf * cos(kesi_new.steering_angle) + Fxf * sin(kesi_new.steering_angle)) * lf - Fyr * lr);
