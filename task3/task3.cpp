...
{
private:
    float pCy1=1.434,lCy=1,pDy1=2.716,pDy2=-0.5444,pDy3=5.19,pKy1=-53.22,pKy2=2.06,pKy3=0.8336,lFz0=1,lKy=1,pEy1=-0.4869,pEy2=-1.487,pEy3=0.06282,pEy4=1.154,lEy=1,pHy1=0,pHy2=0,pHy3=-0.0203,lHy=1,pVy1=0,pVy2=0,pVy3=-2.713,pVy4=-1.517,lVy=1,lmuy=1,lgammay=1;
    float By,Cy,Dy,Ey,Ky,SHy,SVy,muy;
    float gamma=-0.0349,gammay,alphay;
    
public:
    MagicTireModel(){}

    float solveFy(float alpha, float Fz, float Fz0){
